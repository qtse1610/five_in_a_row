        ...
        onClicked: {
            ...
            if (tmp === 0 && Math.round(mouse.x / chessSize) > 0 && Math.round(
                ...
                var newEntityProperties = {
                    ...
                    type: player1_turn ? 1 : 2
                }
                //                console.log("index", Math.floor(mouse.x / chessSize),
                //                            Math.floor(mouse.y / chessSize), tmp)
                //                console.log("index", Math.round(mouse.x / chessSize),
                //                            Math.round(mouse.y / chessSize), tmp)
                chessSound.play()
                entityManager.createEntityFromUrlWithProperties(
                            Qt.resolvedUrl("ChessMan.qml"), newEntityProperties)

                field[index(Math.round(mouse.y / chessSize), Math.round(
                                mouse.x / chessSize))] = (player1_turn ? 1 : 2)

                //                console.log("callIdex: ",
                //                            field[index(Math.round(mouse.x / chessSize),
                //                                        Math.round(mouse.y / chessSize))])

                //                console.log("check before :", Math.round(mouse.x / chessSize),
                //                            Math.round(mouse.y / chessSize), tmp)
                checkWin(Math.round(mouse.y / chessSize),
                         Math.round(mouse.x / chessSize),
                         (player1_turn ? 1 : 2))
                //gameArea.array()
                switchTurn()
